          ...
          <table className="versions">
            <tbody>
              <tr>
                ...
                <td>
                  <a
                    href={`${siteConfig.baseUrl}${siteConfig.docsUrl}${props.language}/Installation.html`}>
                    Documentation
                  </a>
                </td>
                <td>
          ...
          <table className="versions">
            <tbody>
              <tr>
                ...
                <td>
                  <a
                    href={`${siteConfig.baseUrl}${siteConfig.docsUrl}/${props.language}next/Installation.html`}>
                    Documentation
                  </a>
                </td>
                <td>
                ...
                (version) =>
                  version !== latestVersion && (
                    <tr key={version}>
                      ...
                      <td>
                        <a
                          href={`${siteConfig.baseUrl}${siteConfig.docsUrl}/${props.language}/${version}/Installation.html`}>
                          Documentation
                        </a>
                      </td>
                    </tr>
