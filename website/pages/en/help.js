...
class Help extends React.Component {
  render() {
    const supportLinks = [
      {
        content:
          'Learn more using the [documentation on this site.](/AppImageUpdaterBridge/docs/Installation.html)',
        title: 'Browse Docs',
      },
      {
      ...
      {
        content: "If you ever face any problem , please raise a <a href='https://github.com/antony-jr/AppImageUpdaterBridge/issues/new'>"+
