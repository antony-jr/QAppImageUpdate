      ...
      <footer className="nav-footer" id="footer">
	    ...
	    >
          ...
          <div>
            ...
            <a
              href="http://stackoverflow.com/questions/tagged/AppImage/"
              target="_blank">
              Stack Overflow
            </a>
          ...
          <div>
            ...
            <a href="https://github.com/antony-jr/AppImageUpdaterBridge">GitHub</a>
            <a
              className="github-button"
              href={this.props.config.repoUrl}
              data-icon="octicon-star"
              data-count-href="/antony-jr/AppImageUpdaterBridge/stargazers"
