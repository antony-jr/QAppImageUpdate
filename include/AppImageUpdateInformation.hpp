...
public Q_SLOTS:
    AppImageUpdateInformation &waitForFinished(void);
    AppImageUpdateInformation &start(void);
    AppImageUpdateInformation &cancel(void);
    AppImageUpdateInformation &pause(void);
    AppImageUpdateInformation &resume(void);
...
private:
    ...
    QSharedPointer<QFuture<void>> _pFuture = nullptr;
